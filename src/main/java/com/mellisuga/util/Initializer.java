...
final public class Initializer {		
	...
	public static void initialize()
	{
		...
		System.out.print("IMAGESERVER_HOME:" + strDir + "\n");
		if (null == strDir || strDir.isEmpty()){
			strDir = System.getenv("PROCESSERVER_HOME");
			System.out.print("PROCESSERVER_HOME:" + strDir + "\n");
		}
		if (null == strDir || strDir.isEmpty()){
			try{				
				...
				System.out.print("this floder:" + directory.getAbsolutePath() + "\n");	
				inputFile.close();
				ContextImpl.instance().setVariable("BaseDirectory", strDir);
			}
			catch(Exception ex){
				if (null != log){
